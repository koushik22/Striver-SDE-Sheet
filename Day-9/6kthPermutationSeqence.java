 ...
 */
 ...
 // Brute Force : Use recursion to generate all the permutations and put these into a data structure 'ds'. Then sort the data 
 // structure and based on 0-based indexing find ds[k-1].

 // Time Complexity - n!(to generate all the permuations) * n(to make deep copy of every permuatation generated and put 
 // these deep copy into the data structure) * n!logn! (for sorting the list)
